...
`trust_gov_bi` - High trust or trust to some degree = 1 No trust at all or not so much= 0
...
`trust_trust_health_bi` - High trust or trust to some degree = 1 No trust at all or not so much= 0
...
`performance_health_bi` - Good or very good = 1 Not so good or not good at all = 0
